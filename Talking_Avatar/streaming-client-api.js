...
talkButton.onclick = async () => {
  ...
  if (peerConnection?.signalingState === 'stable' || peerConnection?.iceConnectionState === 'connected') {
    ...
    if (userInput.toLowerCase() === '') {
      ...
      userInput.toLowerCase() === 'espresso' ||
      userInput.toLowerCase() === 'iced latte' ||
      userInput.toLowerCase() === 'black coffee' ||
      userInput.toLowerCase() === 'mocha' ||
      userInput.toLowerCase() === 'americano'
    ) {
      drink = userInput;
      ...
      userInput.toLowerCase() === 'small' ||
      userInput.toLowerCase() === 'medium' ||
      userInput.toLowerCase() === 'large'
    ) {
      size = userInput;
      ...
      scriptText = "Thanks for ordering with us. Your drink is" + drink +" and thee size is"+ size + ".You can collect your drink from the counter.";
    } else {
